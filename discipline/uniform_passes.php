...
<div class="card-panel">
    ...
    <form method="GET" class="filter-bar d-flex justify-content-between align-items-center">
        <div class="d-flex align-items-center gap-2 flex-grow-1">
            ...
            <?php if ($search): ?><a href="<?= BASE_PATH ?>/discipline/uniform_passes.php" class="btn btn-outline-secondary btn-sm">Clear</a><?php endif; ?>
        </div>
    </form>
        ...
        <table class="data-table">
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <div class="user-cell">
                            <?= getAvatarHtml(null, $h['first_name'].' '.$h['last_name'], 'user-avatar') ?>
                            <div class="user-info">
