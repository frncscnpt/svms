<?php
/**
 * SVMS - Print Uniform Pass (Discipline Officer)
 */
...
<div class="no-print">
    <a href="<?= BASE_PATH ?>/discipline/uniform_passes.php" class="btn-back">Back</a>
...
<script>
    ...
    // Suggest printing immediately after generated
    setTimeout(function() {
        // window.print();
    }, 500);
</script>
